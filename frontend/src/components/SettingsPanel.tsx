  ...
  return (
    <section className="surface p-4">
      <div className="flex items-center gap-2">
        <SlidersHorizontal className="h-4 w-4 text-ink-600" aria-hidden="true" />
        <h2 className="section-title">Translation Settings</h2>
      </div>

      <div className="mt-5 grid gap-5 lg:grid-cols-2">
        <fieldset className="space-y-4">
          <legend className="flex items-center gap-2 text-sm font-medium text-deep-900 dark:text-ink-50">
            <Gauge className="h-4 w-4 text-ink-600" aria-hidden="true" />
            Translation Tuning
          </legend>
        ...
        <fieldset className="space-y-4">
          <legend className="flex items-center gap-2 text-sm font-medium text-deep-900 dark:text-ink-50">
            <Mic2 className="h-4 w-4 text-ink-600" aria-hidden="true" />
            Speech and Display
          </legend>
          <label className="field-label">
            <span>Voice</span>
